...
public:
	Gdiplus::Bitmap  *m_pSelectedImage;
	HANDLE	m_hThreadTools;
	long	m_MenuCommand;
	void	*m_fp[4];

    inline Gdiplus::Bitmap *GetImage() { return m_pSelectedImage; }
// Overrides
	...
	void SelectFolder( LPCWSTR pstr );
...
protected:
    ...
    Gdiplus::Bitmap* imageUndo[MAX_UNDO_LEVELS];
